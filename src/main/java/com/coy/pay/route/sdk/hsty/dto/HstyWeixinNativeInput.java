 ...
 */
public class HstyWeixinNativeInput extends HstyPayApiInput<HstyWeixinNativeResult> {

    public HstyWeixinNativeInput() {
        super();
        // 初始化服务名称
        this.setService(HstyPayApiConsts.PAY_WECHAT_NATIVE);
    }
