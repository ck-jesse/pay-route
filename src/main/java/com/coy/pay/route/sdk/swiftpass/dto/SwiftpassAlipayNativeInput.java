 ...
 */
public class SwiftpassAlipayNativeInput extends SwiftpassPayApiInput<SwiftpassAlipayNativeResult> {

    public SwiftpassAlipayNativeInput() {
        super();
        // 初始化服务名称
        this.setService(SwiftpassPayApiConsts.PAY_ALIPAY_NATIVE);
    }
